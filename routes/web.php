...
Route::get('register', [\App\Http\Controllers\RegistrasiController::class,'create'])->name('register')->middleware('guest');
Route::post('register', [\App\Http\Controllers\RegistrasiController::class,'store']);
